...
try{
	...
	PreparedStatement ps=con.prepareStatement("update users set adderss=?,city=?,state=?,country=?,mobileNumber=? where email=?");
	ps.setString(1,adderss);
	ps.setString(2,city);
